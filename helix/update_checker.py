...
from helix.version_manager import SemanticVersion, UpdateChannel, get_current_version, is_newer

logger = logging.getLogger(__name__)

# GitHub repository info
GITHUB_OWNER = "sujay-d07"
GITHUB_REPO = "helix"
GITHUB_API_URL = f"https://api.github.com/repos/{GITHUB_OWNER}/{GITHUB_REPO}/releases"

# Cache settings
CACHE_DIR = Path.home() / ".helix" / "cache"
...
class UpdateChecker:
    """Checks for Helix updates from GitHub."""
    ...
    def _fetch_releases(self) -> list[ReleaseInfo]:
        ...
        headers = {
            ...
            "User-Agent": "Helix-Update-Checker",
        }
...
def should_notify_update() -> ReleaseInfo | None:
    ...
    if os.environ.get("HELIX_UPDATE_CHECK", "1") == "0":
        return None
