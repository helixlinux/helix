"""
Network Configuration and Proxy Detection for Helix
...
class NetworkConfig:
    ...
    def __init__(
        ...
        self.cache_dir = Path.home() / ".helix" / "cache"
    ...
    def configure_apt_proxy(self) -> bool:
        ...
        Creates /etc/apt/apt.conf.d/90helix-proxy
        ...
        apt_conf = f"""# Helix auto-generated proxy configuration
Acquire::http::Proxy "{http_proxy}";
Acquire::https::Proxy "{https_proxy}";
"""

        conf_path = Path("/etc/apt/apt.conf.d/90helix-proxy")
    ...
    def cleanup_apt_proxy(self) -> bool:
        """
        Remove Helix proxy configuration from apt.
