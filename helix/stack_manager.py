...
Usage:
  helix stack --list              # List all stacks
  helix stack ml                  # Install ML stack (auto-detects GPU)
  helix stack ml-cpu              # Install CPU-only version
  helix stack webdev --dry-run    # Preview webdev stack
"""
...
from helix.hardware_detection import has_nvidia_gpu
...
class StackManager:
    ...
    def __init__(self) -> None:
        # stacks.json is in the same directory as this file (helix/)
