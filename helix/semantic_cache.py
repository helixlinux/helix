...
from helix.utils.db_pool import SQLiteConnectionPool, get_connection_pool
...
class SemanticCache:
    ...
    def __init__(
        self,
        db_path: str = "/var/lib/helix/cache.db",
        ...
        self.max_entries = (
            ...
            else int(os.environ.get("HELIX_CACHE_MAX_ENTRIES", "500"))
        )
        self.similarity_threshold = (
            similarity_threshold
            if similarity_threshold is not None
            else float(os.environ.get("HELIX_CACHE_SIMILARITY_THRESHOLD", "0.86"))
        )
