"""
Thread-safe SQLite connection pooling for Helix Linux.
...
def get_connection_pool(
    ...
    Example:
        from helix.utils.db_pool import get_connection_pool

        pool = get_connection_pool("/var/lib/helix/cache.db")
        with pool.get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute("SELECT ...")
    """
